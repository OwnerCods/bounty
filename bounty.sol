...
/**
 * @title Bounties
 * Простой смарт контракт который позволяет любому пользователю выдавать Баунти в привязке к требованиям хранящимся в ipfs
 * которые любой желающий может выполнить, отправив hash ipfs, содержащий доказательства их выполнения
 * 
 */
contract Bounties {         // контракт выплоты баунти за выполненое задание
    /*
  * Enums 
  */
  ...
  */
  ...
  /** @dev cancelBounty(): отменяет bounty и отправляет средства обратно эмитенту
  * @param _bountyId the index of the bounty
  */
